...
| `value` | <code>[`LiquidJsonValue`](#liquidjsonvalue)</code> |The packet payload.|||
...
## WebSocketClientComponent
  ...
  <p>
    <div style="font-style:italic">A component whose operations are WebSocket connection.</div>
  </p>
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `kind` | `string` | must be `"wick/component/websocket@v1"` | Yes | || `resource` | <code>`string`</code> |The URL of the WebSocket server.|||
| `with` | <code>[`Field`](#field)[]</code> |Configuration necessary to provide when instantiating the component.|||
| `operations` | <code>[`WebSocketClientOperationDefinition`](#websocketclientoperationdefinition)[]</code> |A list of operations to expose on this component.|||
...
## WebSocketClientOperationDefinition
  ...
  <p>
    <div style="font-style:italic">A dynamic operation whose implementation is a WebSocket message. The outputs of WebSocketOperationDefinition are always `message`.</div>
  </p>
...
| `with` | <code>[`Field`](#field)[]</code> |Any configuration required by the operation.|||
| `inputs` | <code>[`Field`](#field)[]</code> |Types of the inputs to the operation.|||
| `path` | <code>`string`</code> |The path / query string to append to our base URL, processed as a liquid template with each input as part of the template data.|||
| `message` | <code>[`LiquidJsonValue`](#liquidjsonvalue)</code> |The message to send, processed as a structured JSON liquid template.|||
