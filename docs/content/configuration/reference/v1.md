...
| `experimental` | <code>[`ExperimentalCompositeConfig`](#experimentalcompositeconfig)</code> |Experimental configuration for composite components.|||



--------

## ExperimentalCompositeConfig

  <p>
    <div style="font-style:italic">Settings that may change in the future. Use at your own risk.</div>
  </p>
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `expose` | <code>`string`</code> |A component whose operations you want to expose from this component.|||
