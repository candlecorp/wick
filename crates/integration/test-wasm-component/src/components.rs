  ...
  pub mod copy {
    ...
    pub fn convert_inputs(
      ...
      Ok(definition::Inputs {
        ...
        times: payload
          .remove("times")
          .ok_or_else(|| wasmflow_sdk::v1::error::Error::MissingInput("times".to_owned()))?
          .deserialize()?,
      })
    }
    ...
    pub fn convert_inputs(
      ...
      Ok(definition::Inputs {
        ...
        times: wasmflow_sdk::v1::codec::messagepack::deserialize(payload.get("times")?)?,
      })
    }
    ...
    impl From<Inputs> for wasmflow_sdk::v1::packet::PacketMap {
      fn from(inputs: Inputs) -> wasmflow_sdk::v1::packet::PacketMap {
        ...
        map.insert(
          "times".to_owned(),
          wasmflow_sdk::v1::packet::v1::Packet::success(&inputs.times).into(),
        );
    ...
    pub fn inputs_list() -> std::collections::HashMap<String, wasmflow_sdk::v1::types::TypeSignature> {
      ...
      map.insert("times".to_owned(), wasmflow_sdk::v1::types::TypeSignature::I8);
      map
    }
