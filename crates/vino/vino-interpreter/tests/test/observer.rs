...
use vino_interpreter::{EventKind, Observer};
...
impl Observer for JsonWriter {
  fn on_event(&self, index: usize, event: &vino_interpreter::Event) {
  ...
  fn on_after_event(&self, _index: usize, state: &vino_interpreter::State) {
