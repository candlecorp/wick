...
use crate::signatures::{CollectionSignature, OperationSignature, ParseError, TypeSignature};
...
pub struct FieldMap(pub HashMap<String, TypeSignature>);
...
impl CollectionMap {
  kv_impl! {CollectionSignature, pub}
}
...
pub struct OperationMap(pub HashMap<String, OperationSignature>);

impl OperationMap {
  kv_impl! {OperationSignature, pub}
}

impl From<HashMap<String, OperationSignature>> for OperationMap {
  fn from(map: HashMap<String, OperationSignature>) -> Self {
    Self(map)
  }
}

impl From<HashMap<&str, OperationSignature>> for OperationMap {
  fn from(map: HashMap<&str, OperationSignature>) -> Self {
