...
| `with` | <code>[`Field`](#field)[]</code> |Configuration necessary to provide when instantiating the component.|||
| `headers` | <code>`{` `string` `: ` `string`[] `}`</code> |Any headers to add to the initial connection request.|||
...
| `inputs` | <code>[`Field`](#field)[]</code> |Types of the inputs to the operation.|||
| `codec` | <code>[`Codec`](#codec)</code> |The codec to use when encoding/decoding data.|||
| `outputs` | <code>[`Field`](#field)[]</code> |Types of the outputs from the operation.|||
| `message` | <code>[`LiquidJsonValue`](#liquidjsonvalue)</code> |The message to send, processed as either json, text, or bytes.|||
