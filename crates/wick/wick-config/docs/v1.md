...
See [liquid-json](https://crates.io/crates/liquid-json) for more information.</div>
  </p>
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `kind` | `string` | must be `"wick/resource/tcpport@v1"` | Yes | || `port` | <code>`u16`</code> |The port to bind to.|||
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `kind` | `string` | must be `"wick/resource/udpport@v1"` | Yes | || `port` | <code>`u16`</code> |The port to bind to.|||
| `address` | <code>`string`</code> |The address to bind to.|||
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `kind` | `string` | must be `"wick/resource/volume@v1"` | Yes | || `path` | <code>`string`</code> |The path.|Yes||
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `kind` | `string` | must be `"wick/resource/url@v1"` | Yes | || `url` | <code>`string`</code> |The url string.|Yes||
...
| `with` | <code>`{` `string` `: ` `any` `}`</code> |Configuration to pass to this operation on invocation.|||
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `uri` | <code>`string`</code> |The path to serve this route from. See [URI documentation](/docs/configuration/uri) for more information on specifying query and path parameters.|Yes||
...
| `methods` | <code>`string`[]</code> |The HTTP methods to serve this route for.|||
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `openapi` | <code>`string`</code> |The path to serve the OpenAPI spec from|||
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `name` | <code>`string`</code> |The name of the license.|||
...
| `with` | <code>`{` `string` `: ` `any` `}`</code> |Configuration used to instantiate this component.|||
...
| Field name | Type | Description | Required? | Shortform? |
|------------|------|-------------|-----------|------------|
| `kind` | `string` | must be `"wick/component/composite@v1"` | Yes | || `with` | <code>[`Field`](#field)[]</code> |Configuration necessary to provide when instantiating the component.|||
| `operations` | <code>[`CompositeOperationDefinition`](#compositeoperationdefinition)[]</code> |A list of operations exposed by the Composite component.|||
...
| `with` | <code>`{` `string` `: ` `any` `}`</code> |Any configuration necessary for the component.|||
...
| `data` | <code>`{` `string` `: ` `any` `}`</code> |The default value to provide on this connection in the event of an error.|||
...
| `with` | <code>`{` `string` `: ` `any` `}`</code> |Data to associate with the reference, if any.|||
...
| `with` | <code>`{` `string` `: ` `any` `}`</code> |The configuration for the operation, if any.|||
| `input` | <code>[`PacketData`](#packetdata)[]</code> |The inputs to the test.|||
| `output` | <code>[`PacketData`](#packetdata)[]</code> |The expected outputs of the operation.|||
...
| `value` | <code>`any`</code> |The data to send.|||
...
| `name` | <code>`string`</code> |The name of the input or output this packet is going to or coming from.|Yes||
| `flags` | <code>[`PacketFlags`](#packetflags)</code> |Any flags set on the packet.|||
| `error` | <code>`string`</code> |The error message.|Yes||
