...
impl Dispatch for Dispatcher {
  ...
  async fn dispatch(
    ...
    let result = match op {
      ...
      "gate" => {
        generated::gate::Component::default()
          .execute(context, data)
          .await
      }
      "log" => {
      ...
      "negate" => {
        generated::negate::Component::default()
          .execute(context, data)
          .await
      }
      "panic" => {
      ...
      "short-circuit" => {
        generated::short_circuit::Component::default()
          .execute(context, data)
          .await
      }
      "string-to-bytes" => {
        generated::string_to_bytes::Component::default()
          .execute(context, data)
          .await
      }
      "uuid" => {
