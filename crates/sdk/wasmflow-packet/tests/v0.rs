...
static STRING_BYTES: [u8; 21] = [
  129, 162, 118, 48, 129, 161, 51, 156, 204, 171, 72, 101, 108, 108, 111, 32, 119, 111, 114, 108, 100,
];
// Exception("Test exception message")
static EXCEPTION_BYTES: [u8; 30] = [
  129, 162, 118, 48, 129, 161, 49, 182, 84, 101, 115, 116, 32, 101, 120, 99, 101, 112, 116, 105, 111, 110, 32, 109,
  101, 115, 115, 97, 103, 101,
];
// Exception("Test error message")
static ERROR_BYTES: [u8; 26] = [
  129, 162, 118, 48, 129, 161, 50, 178, 84, 101, 115, 116, 32, 101, 114, 114, 111, 114, 32, 109, 101, 115, 115, 97,
  103, 101,
];
...
fn exception() -> Result<()> {
  ...
  assert_eq!(payload, Packet::V0(Payload::Exception(user_data.to_string())));
  Ok(())
}
