...
pub mod generated {
  ...
  pub mod __multi__ {
    ...
    pub enum ComponentInputs {
      ...
      Log(super::log::Inputs),
      Panic(super::panic::Inputs),
      RandomBytes(super::random_bytes::Inputs),
      RandomString(super::random_string::Inputs),
      Uuid(super::uuid::Inputs),
    }
    ...
    pub enum ComponentOutputs {
      ...
      Log(super::log::Outputs),
      Panic(super::panic::Outputs),
      RandomBytes(super::random_bytes::Outputs),
      RandomString(super::random_string::Outputs),
      Uuid(super::uuid::Outputs),
    }
